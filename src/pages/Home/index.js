...
export default function HomeScreen({navigation}) {
  ...
  const getFilmesAcao = async()=>{
    try{
      const response = await fetch('http://10.67.4.20:8000/api/filme-acao')
  ...
  const getFilmesAnimacao = async()=>{
    try{
      const response = await fetch('http://10.67.4.20:8000/api/filme-animacao')
      const json = await response.json();
  ...
  const getFilmesAventura = async()=>{
    try{
      const response = await fetch('http://10.67.4.20:8000/api/filme-aventura')
      const json = await response.json();
  ...
  const getFilmesDrama = async()=>{
    try{
      const response = await fetch('http://10.67.4.20:8000/api/filme-drama')
      const json = await response.json();
  ...
  const getFilmesComedia = async()=>{
    try{
      const response = await fetch('http://10.67.4.20:8000/api/filme-comedia')
      const json = await response.json();
  ...
  const getFilmesSuspense = async()=>{
    try{
      const response = await fetch('http://10.67.4.20:8000/api/filme-suspense')
      const json = await response.json();
